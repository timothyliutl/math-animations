...
class Example_Problem(Scene):
    def construct(self):
        ...
        eq1_int = MathTex(r'r_1(t) = ', r'<', r't+1', r',', r't', r'>').set_color(BLUE).scale(0.8).set_stroke(width=2,color=WHITE)
        eq2_int = MathTex(r'r_2(t) = ',r'<', r't', r',', r'\sqrt{t}', r'>').set_color(RED).scale(0.8).set_stroke(width=2,color=WHITE)
        ...
        eq1_coll = MathTex(r'r_1(t) = ' ,r'<', r't^2', r',', r't+2', r'>').set_color(BLUE).scale(0.6).set_stroke(width=2,color=WHITE)
        eq2_coll = MathTex(r'r_2(t) = ',r'<', r't+3', r',', r'3t-2', r'>').set_color(RED).scale(0.6).set_stroke(width=2,color=WHITE)
